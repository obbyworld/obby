  ...
  config = mkIf cfg.enable (mkMerge [
    {
      ...
      assertions = [
        ...
        }
        {
          ...
          message = "programs.obby.viteBuildEnv requires a package produced by ObsidianIRC’s flake/overlay (`callPackage` .override support). Replace `programs.obby.package` or simplify `viteBuildEnv`.";
        }
      ];
