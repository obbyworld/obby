...
// bundle behaves identically under Node ESM, Vite, and vitest. Frozen protocol;
// the dated primitives (SHA-1, DSA-1024, DH-1536) are inherent to OTRv3.
const root = { crypto: (typeof globalThis !== "undefined" ? globalThis.crypto : undefined) };
;(function () {
var module, define, exports;
;
/* ===== CryptoJS ===== */
...
export const OTR = root.OTR;
export const DSA = root.DSA;
export default { OTR: root.OTR, DSA: root.DSA };
